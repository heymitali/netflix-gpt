    ...
    <div>
      ...
      <div className="absolute w-full flex justify-center">
        <form
          ...
          className="z-20 p-2 px-5 bg-black bg-opacity-60 text-white xl:my-6 xl:mx-auto right-0 left-0 rounded-lg h-auto w-[30rem] sm:w-[18rem] lg:w-[20rem] xl:w-[25rem] mt-28 sm:mt-20 lg:mt-28 xl:mt-32 2xl:mt-40 mx-6"
        >
